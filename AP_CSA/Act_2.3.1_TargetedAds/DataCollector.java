...
public class DataCollector {
   ...
   * space
   * 
   * @param socialMediaPostsFilename the name of the file containing social media
   *                                 posts
   * @param targetWordsFilename      the name of the file containing the target
   *                                 words
   */
   ...
   * or "NONE" if there is no more data.
   * After reaching the end of its data, the next call to this method with restart
